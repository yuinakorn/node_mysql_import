...
function executeShellCommand(cmd, msg) {
    return new Promise(resolve => {
        ...
        let sql = "INSERT INTO `hdc_log_cm_copy1` (`server_name`, `process_name`, `process_date`) VALUES (?, ?, ?);";
...
function check_status() {
    return new Promise(resolve => {
        let sql = "select left(process_name,1) as p_name  from hdc_log_cm_copy1 where left(process_name,1) = '4'  order by process_date desc limit 1;";
